...
import { ExternalLink, FileText, Globe, Lock, Shield, User } from "lucide-react";
...
export default function AppsDeveloperDetail({ config }: { config: Config }) {
    const details = [
        ...
        { label: "Documentation", value: config.documentationUrl, icon: FileText, isLink: true },
        { label: "Terms & Conditions", value: config.termsAndConditionsUrl, icon: Shield, isLink: true },
        { label: "Privacy Policy", value: config.privacyPolicyUrl, icon: Lock, isLink: true },
    ]
                        ...
                        {item.isLink ? (
                            ...
                            >
                                <div className="flex items-center space-x-2">
                                    ...
                                    <p className="text-md font-medium leading-none">{item.label}</p>
                                </div>
