...
interface TimeSeriesAreaChartProps<T extends TimeseriesDataType> extends React.HTMLAttributes<HTMLDivElement> {
    data?: Array<T>;
    className?: string;
    link?: string;
    title?: string;
 ...
 */
const TimeSeriesAreaChart: React.FC<TimeSeriesAreaChartProps<TimeseriesDataType>> = React.memo(
    ({
        data,
        className,
        link,
