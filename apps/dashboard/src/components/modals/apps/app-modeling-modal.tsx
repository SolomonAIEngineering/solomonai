...
export function AppsModellingModal({
    isOpen, onClose, appType, cfg, id, installed
                ...
                <DialogHeader className="md:p-[3%] bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                            <Logo />
                            <div>
                                <DialogTitle className="text-3xl font-bold">{capitalize(appName)}</DialogTitle>
                    ...
                    <div className="md:p-[2%]">
                        <div className="flex justify-between">
                            <Button onClick={handleConfirm} disabled={addAppToAccount.status === 'executing'}>
                ...
                <DialogFooter className="p-6 bg-muted mt-auto">
                    <div className="flex justify-between items-center w-full">
                        <p className="text-xs text-muted-foreground mx-[2]">
                            ...
                            are officially certified. Report any concerns about app content or behavior.
                        </p>
                    </div>
                </DialogFooter>
            </DialogContent>
