...
interface TransactionAnalyticsActiveEnergyChartProps extends React.HTMLAttributes<HTMLDivElement> { 
    className?: string
}

export function TransactionAnalyticsActiveEnergyChart({ className }: TransactionAnalyticsActiveEnergyChartProps) {
    return (
