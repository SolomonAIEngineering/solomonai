...
interface TransactionAnalyticsStepsChartProps extends React.HTMLAttributes<HTMLDivElement> {
    className?: string
}

export function TransactionAnalyticsStepsChart({ className }: TransactionAnalyticsStepsChartProps) {
    return (
        <Card className={cn("lg:max-w-md", className)}>
